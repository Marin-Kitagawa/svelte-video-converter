...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__sveltestrap_sveltestrap: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__sveltestrap_sveltestrap: string;
